...
| `AGENT_UPDATES_ENABLED`          | `false`                      | Enables the GitHub release catalog and managed update campaign API. Campaign creation remains fail-closed unless a canonical compatible manifest is available from the pinned repository and channel. |
