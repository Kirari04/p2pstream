...
| Vault Transit unavailable | Check `SECRETS_ENCRYPTION_VAULT_ADDR`, HTTPS trust, namespace, token, mount, key name, and Transit permissions. Startup fails closed while the provider cannot be checked. |
