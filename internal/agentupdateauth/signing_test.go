...
func TestSigningPayloadVectors(t *testing.T) {
	tests := []struct {
		...
		{"activation", ActivationPayload(Activation{AgentPublicID: "a", AssignmentID: 2, Generation: 3, Counter: 4, Nonce: []byte{0xaa}, ManifestSHA256: "m", TargetVersion: "v", TargetCommit: "c", ReleaseSequence: 5, SecurityEpoch: 6, OS: "linux", Arch: "amd64", ArtifactName: "agent", ArtifactSize: 8, ArtifactSHA256: "b"}), ""},
	}
