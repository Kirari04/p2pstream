...
const routes = [
  ...
  { path: '/proxy', redirect: '/proxy/sites' },
  { path: '/proxy/routes', redirect: '/proxy/sites' },
  { path: '/proxy/:section(sites|listeners)', name: 'proxy', component: ProxyConfig },
  { path: '/proxy/:pathMatch(.*)*', redirect: '/proxy/sites' },
