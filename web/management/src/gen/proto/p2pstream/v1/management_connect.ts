...
export const AgentManagementService = {
  ...
  methods: {
    ...
    listPublicBackendHealthTraces: {
      name: "ListPublicBackendHealthTraces",
      I: ListPublicBackendHealthTracesRequest,
      O: ListPublicBackendHealthTracesResponse,
      kind: MethodKind.Unary,
    },
    /**
