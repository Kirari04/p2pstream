...
func TestProxyRequestEventRecordedCountsOnly(t *testing.T) {
	...
	expected := []string{"agent_id", "cache_bytes", "cache_rule_id", "cache_status", "duration_ms", "error_kind", "host", "id", "listener_id", "method", "occurred_at", "path_prefix", "request_bytes", "response_bytes", "retry_count", "retry_error_kind", "retry_failed_agent_id", "retry_outcome", "retry_rule_id", "route_id", "route_target_id", "status_code", "waf_action", "waf_rule_id"}
