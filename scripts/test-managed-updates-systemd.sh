...
tar -czf "${build_dir}/fixture.tar.gz" -C "$build_dir" server.test p2pstream-v1.0.0 p2pstream-v1.1.0 p2pstream-v1.2.0 install-agent.sh uninstall-agent.sh
...
printf 'Running installer, real services, signed reports and repeated rollout in %s...\n' "$vm_name"
result=0
